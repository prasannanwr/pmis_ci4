                    	...
                    	<?php $i=1; if (!empty($arrDataList)): foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td>
                                    ...
                                    <a class="confirmation" data-href="<?php echo site_url('development_region');?>/delete/?id=<?php echo $objData->supplier_id;?>" data-toggle="confirmation"  data-singleton="true" data-placement="left" data-btnOkClass="btn-danger" data-btnCancelClass="btn-success" data-title="Are you sure to delete?" data-data accesskey="ss" >
