<div id="page-wrapper" class="largeRpt">
    <div class="alignRight">
        <form method="post" target="_blank" action="<?php echo site_url();?>reports/overall_bulldog_issue_print">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-10 mainBoard ">
                ...
                <h2 class="alignLeft">Overall summary of Bulldog grips Issued</h2>
            </div>
            <div class="col-lg-10 mainBoard">
                <div class=" table-responsive" >
                    <table class="table table-bordered table-hover" style="width:700px" align="center">
                        <thead>
                        <tr>
                            <th class="center c1">Issued To</th>

                            <th class="center c3">Diameter</th>

                            <th class="center c6">Total Issued</th>
