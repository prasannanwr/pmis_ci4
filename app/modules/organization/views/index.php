    	...
    	<div class="container-fluid">
    		<div class="panel panel-default">
                ...
                <div class="AddBtn">
            	    ...
            	    <?php   echo anchor('organization/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Add Organization</button>'); ?>
            	    <?php endif ?>
               </div>
                    	...
                    	<?php $i=1; if (!empty($arrDataList)): foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td>
                    				...
                    				<?php echo anchor("organization/create/".$objData->organization_id, '<span class="form-edit floatRight">
                                        <img src="'.site_url().'images/edit-btn.png" width="15" height="15"></span>'); ?>
                                    <a class="confirmation" data-href="<?php echo site_url('organization');?>/delete/?id=<?php echo $objData->organization_id;?>" data-toggle="confirmation"  data-singleton="true" data-placement="left" data-btnOkClass="btn-danger" data-btnCancelClass="btn-success" data-title="Are you sure to delete?" data-data accesskey="ss" >
