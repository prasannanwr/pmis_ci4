<div id="page-wrapper" class="largeRpt">
    <div class="alignRight">
        <form method="post" target="_blank" action="<?php echo site_url();?>reports/org_wise_bulldog_issue_report_print">
            <input type="hidden" name="selOrganization" value="<?php echo $organization;?>">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-10 mainBoard ">
                ...
                <h2 class="alignLeft">Summary of bulldog grip[s] issued to: <?php echo $organization_name;?></h2>
            </div>
            <div class="col-lg-10 mainBoard">
