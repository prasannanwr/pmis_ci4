<div id="page-wrapper" class="largeRpt">
    <div class="alignRight">
        <form method="post" target="_blank" action="<?php echo site_url();?>reports/region_wise_summary_bulldog_print">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-10 mainBoard ">
                ...
                <h2 class="center">Region wise Summary of Bulldog grips purchased through GoN fund</h2>
            </div>
            <div class="col-lg-10 mainBoard">
