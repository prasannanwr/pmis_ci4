<div id="page-wrapper" class="largeRpt">
    <div class="alignRight">
        <form method="post" action="<?php echo site_url();?>reports/sbd_cable_ledger_print">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 mainBoard">
                ...
                <h2 class="center">लत्टाको आम्दानी खर्छ विवरण </h2>
                ...
                if($arrCableList) {
                    ...
                    foreach ($arrCableList as $list) {
                        ...
                        <div class=" table-responsive">                        
                            <div class="col-lg-3"><b>लत्टाको मोटाइ :</b> <?php echo $receiptInfo->diametername; ?>mm</div><br>
                            ...
                            ?>
                            <div class="col-lg-3"><b>लत्टाको रील नम्बर :</b><?php echo $lotinfo->lot; ?></div>
                        ...
                        <div class="col-lg-12 mainBoard">
                            <div class=" table-responsive">
                                <table class="table table-bordered table-hover" style="" align="center">
                                    <tr>
                                        <td colspan="5" class="text-right " style="width: 211px;"><b><?php echo $receiptInfo->diametername;?>mm जम्मा:</b></td>
