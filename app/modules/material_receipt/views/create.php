                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php echo et_form_dropdown_db('region', 'regional_office', 'region_name', 'id', et_setFormVal('region', $objOldRec), '', 'class="form-control"') ?>
...
<!--                                </select>-->
                                <?php echo et_form_dropdown_db('type', 'material_type', 'name', 'id', et_setFormVal('type', $objOldRec), '', 'class="form-control"') ?>
...
<!--                                </select>-->
                                <?php echo et_form_dropdown_db('diameter', 'diameter', 'name', 'id', et_setFormVal('diameter', $objOldRec), '', 'class="form-control"') ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="input_id" class="form-control" type="text" name="input_id" maxlength="255" value="<?php echo et_setFormValBlank('input_id', $objOldRec); ?>" readonly="readonly"  />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="lot_no" class="form-control" type="text" name="lot_no" maxlength="255" value="<?php echo et_setFormValBlank('lot', $objOldRec); ?>" readonly="readonly"  />
                    ...
                    <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7 datebox-container ">
                                        <div class="col-lg-10 nopad datetimepicker input-group date ">
                                            ...
                                            <input type="text" class=" form-control " name="receipt_date" id="receipt_date" value="<?php echo et_setFormValBlank('receipt_date', $objOldRec); ?>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <?php echo et_form_dropdown_db('purchased_by', 'funding_agency', 'name', 'id', et_setFormVal('purchased_by', $objOldRec), '', 'class="form-control"') ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <?php echo et_form_dropdown_db('supplier', 'supplier', 'name', 'supplier_id', et_setFormVal('supplier', $objOldRec), '', 'class="form-control"') ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="rate" class="form-control" type="text" name="rate" maxlength="255" value="<?php echo et_setFormValBlank('rate', $objOldRec); ?>"  />
