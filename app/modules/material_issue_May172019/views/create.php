                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php echo et_form_dropdown_db('requisition_num', 'requisition', 'req_id', 'id', et_setFormVal('req_id', $objOldRec), array(0=>'region',1=>$region), 'class="form-control"') ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="issued_to" class="form-control" type="text" name="issued_to" maxlength="255" value="" readonly="readonly"  />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="bridge_name" class="form-control" type="text" name="bridge_name" maxlength="255" value="" readonly="readonly"  />
                        ...
                        <div class="form-group">
                                    ...
                                    <div class="col-lg-7 datebox-container ">
                                        <div class="col-lg-10 nopad datetimepicker input-group date ">
                                            ...
                                            <input type="text" class=" form-control " name="issued_date" id="issued_date" value=""/>
                                        </div>
                                    </div>
