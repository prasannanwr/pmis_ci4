<?php
	...
	if (isset($department_info))
	{
		...
		{
			if (in_array($dept['id'], $dept_common))
			{
...
<?php if (check_access(array('access_view'), $dep_id)): ?>
<div class="control-group check_boxes">
	...
	<div class="controls">
		...
		<?php if (check_access(array('access_org'), $dep_id)): ?>
		<label class="checkbox inline">
		...
		<?php endif ?>
		<?php if (check_access(array('access_dep'), $dep_id)): ?>
		<label class="checkbox inline">
		...
		<?php endif ?>
		<?php if (check_access(array('access_emp'), $dep_id)): ?>
		<label class="checkbox inline">
		...
		<?php endif ?>
		<?php if (check_access(array('access_eqp'), $dep_id)): ?>
		<label class="checkbox inline">
		...
		<?php endif ?>
		<?php if (check_access(array('access_chkst'), $dep_id)): ?>
		<label class="checkbox inline">
		...
		<?php endif ?>
		<?php if (check_access(array('access_assign_eqp'), $dep_id)): ?>
		<label class="checkbox inline">
		...
		<?php endif ?>
		<?php if (check_access(array('access_assign_deg'), $dep_id)): ?>
		<label class="checkbox inline">
...
<div class="control-group check_boxes">
	...
	<div class="controls">
		<label class="checkbox inline">
			<input type="checkbox" value="org_add" name="access_org[]" id="org_add" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'org_add'); ?>>Add
		</label>

		<label class="checkbox inline">
			<input type="checkbox" value="org_edit" name="access_org[]" id="org_edit" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'org_edit'); ?>>Edit
		</label>
		<label class="checkbox inline">
			<input type="checkbox" value="org_delete" name="access_org[]" id="org_delete" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'org_delete'); ?>>Delete
		</label>
	</div>
</div>
<?php endif ?>
...
<div class="control-group check_boxes">
	...
	<div class="controls">
		<label class="checkbox inline">
			<input type="checkbox" value="dep_add" name="access_dep[]" id="dep_add" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'dep_add'); ?>>Add
		</label>
		<label class="checkbox inline">
			<input type="checkbox" value="dep_edit" name="access_dep[]" id="dep_edit" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'dep_edit'); ?>>Edit
		</label>
		<label class="checkbox inline">
			<input type="checkbox" value="dep_delete" name="access_dep[]" id="dep_delete" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'dep_delete'); ?>>Delete
		</label>
	</div>
</div>
<?php endif ?>
...
<div class="control-group check_boxes">
	...
	<div class="controls">
		<label class="checkbox inline">
			<input type="checkbox" value="emp_add" name="access_emp[]" id="emp_add" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'emp_add'); ?>>Add
		</label>
		<label class="checkbox inline">
			<input type="checkbox" value="emp_edit" name="access_emp[]" id="emp_edit" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'emp_edit'); ?>>Edit
		</label>
		<label class="checkbox inline">
			<input type="checkbox" value="emp_delete" name="access_emp[]" id="emp_delete" class="check_boxes" <?php echo is_checked($emp_access_general_info, 'emp_delete'); ?>>Delete
		</label>
	</div>
</div>
<?php endif ?>
