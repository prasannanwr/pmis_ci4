    	...
    	<div class="container-fluid">
    		<div class="panel panel-default">
                ...
                <div class="AddBtn">
            	    ...
            	    <?php echo anchor('work_category/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Create work_category</button>'); ?>
            	    <?php //endif ?>
               </div>
    
                <?php if (empty($arrDataList)): ?>
                <div id="infoMessage" class="alert alert-info">No Work Category found.</div>
                <?php else: ?>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                    	...
                    	<?php $i=1; foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td><?php echo $i++;?></td>
                    			<td>
                    				<?php // echo anchor('work_category/view/'.$objData->wkc01id, $objData->wkc01work_category_code); ?>
                    			<?php echo $objData->wkc01work_category_code; ?>
                                 </td>
                    			
                    			<td>
                    				<?php echo $objData->wkc01work_category_name; ?>
                    			</td>
                    			<td>
                    				<?php if (check_access_general(array('emp_edit'))): ?>
                    				<?php echo anchor("work_category/create/".$objData->wkc01id, '<span class="form-edit floatRight">
                                        <img src="'.base_url('images/edit-btn.png').'" width="15" height="15"></span>'); ?>
                                    <a class="confirmation" data-href="<?php echo site_url('work_category');?>/delete/?id=<?php echo $objData->wkc01id;?>" data-toggle="confirmation"  data-singleton="true" data-placement="left" data-btnOkClass="btn-danger" data-btnCancelClass="btn-success" data-title="Are you sure to delete?" data-data accesskey="ss" >
