    ...
    <div class="row">
        <div class="panel panel-primary registration">
            ...
            <div class="panel-body">
                ...
                <?php endif; ?>
                <form class="" action="<?=site_url('user/edit/'.$arrData['id']);?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="phone_no">Selected District</label>
                        ...
                        <?php // echo form_dropdown('District', $arrDistList, '');?>
                         ...
                         <?php /*if($distList) { ?>
                            <p style="width: 95%;overflow-x: auto; height: 61px;">
                            <?php foreach ($distList as $value) {
                                echo "<span style='background-color:#cacaca; padding: 5px'>".$value->dist01name."</span>&nbsp;";
                            } ?>
                            </p>
                            <?php
                         }*/?>
