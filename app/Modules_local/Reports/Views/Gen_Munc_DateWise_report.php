...
<div id="page-wrapper" class="largeRpt">
  ...
  <div class="col-lg-4 right"></div>   
    ...
    <div class="col-lg-3"><?php //echo _day(); 
                            ?></div><div class="col-lg-6 "><span class="center">TBSU Programme Monitoring and Information Systerm PMIS</span></div><div class="col-lg-3 right"><!--<span>Page 1 of 3</span> -->
            <!--</div>
               </div>    -->
            <!---footer-->
