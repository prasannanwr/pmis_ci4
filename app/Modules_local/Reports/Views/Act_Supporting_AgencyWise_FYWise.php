...
<div id="page-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row center">
      <h3>Actual Bridge Cost (Supporting Agency Wise)</h3>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 clearfix">
        <form action="<?php echo site_url(); ?>/reports/Act_Supporting_AgencyWise_FYWise_report<?php echo (isset($blnMM) && $blnMM) ? '/' . MM_CODE : ''; ?>" method="post">
