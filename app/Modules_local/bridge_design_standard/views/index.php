    	...
    	<div class="container-fluid">
    		<div class="panel panel-default">
                ...
                <div class="AddBtn">
            	    ...
            	    <?php echo anchor('bridge_design_standard/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Create Bridge Design Standard</button>'); ?>
            	    <?php //endif ?>
               </div>
    
                <?php if (empty($arrDataList)): ?>
                <div id="infoMessage" class="alert alert-info">No Supporting Bridge Design Standard found.</div>
                <?php else: ?>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                    	...
                    	<?php $i=1; foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td><?php echo $i++;?></td>
                    			<td>
                    				<?php //echo anchor('bridge_design_standard/view/'.$objData->id, $objData->bri02bds_type_code);
                                    echo $objData->bri02bds_type_code; 
                                     ?>
                    			</td>
                    			
                    			<td>
                    				<?php echo $objData->bri02bds_type_name; ?>
                    			</td>
                    			<td>
