            ...
            "serverSide": true,
             ...
             columns: [
                ...
                {type: 'html',
                    ...
                    mRender: function( data, type, full ){
                        //console.log( data );
                        return '<a href="<?php echo site_url();?>bridge/form/'+ data +'">'+ $add +'</a> <?php  if($this->session->userdata('type') == ENUM_ADMINISTRATOR || $this->session->userdata('type') == ENUM_REGIONAL_MANAGER  ){ ?> <a href="<?php echo site_url();?>bridge/delete/?id='+ data +'" onclick="return confirm(\'Warning: Once deleted, the action cannot be reverted. Are you sure you want to delete the selected bridge?\');">'+ $del +'</a> <?php }?>';                        
                    }
                }
             ],       
