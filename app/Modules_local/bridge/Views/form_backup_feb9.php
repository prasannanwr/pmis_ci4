								...
								<div class="form-group clearfix">
									...
									<div class="col-lg-7 ">
										...
										<select name="bri04slope_protection_lb" id="bri04slope_protection_lb" class="form-control valid">
											<option <?=($objbasicRec['bri04slope_protection_lb'] == 'yes')?'selected="selected"':'';?> value="yes">Yes</option>
											<option <?=($objbasicRec['bri04slope_protection_lb'] == 'no')?'selected="selected"':'';?> value="no">No</option>
										</select>
								...
								<div class="form-group clearfix">
									...
									<div class="col-lg-7 ">
										...
										<select name="bri04slope_protection_rb" id="bri04slope_protection_rb" class="form-control valid">
											<option <?=($objbasicRec['bri04slope_protection_rb'] == 'yes')?'selected="selected"':'';?> value="yes">Yes</option>
											<option <?=($objbasicRec['bri04slope_protection_rb'] == 'no')?'selected="selected"':'';?> value="no">No</option>
										</select>
