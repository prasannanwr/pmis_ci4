    	...
    	<div class="container-fluid">
    		<div class="panel panel-default">
                ...
                <div class="AddBtn">
            	    ...
            	    <?php echo anchor('handrail_cable/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Create Handrail Cables</button>'); ?>
            	    <?php //endif ?>
               </div>
    
                <?php if (empty($arrDataList)): ?>
                <div id="infoMessage" class="alert alert-info">No Handrail Cable found.</div>
                <?php else: ?>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                    	...
                    	<?php $i=1; foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td><?php echo $i++;?></td>
                    			<td>
                    				<?php echo anchor('handrail_cable/view/'.$objData->hdc01id, $objData->hdc01hhcn_type_code); ?>
                    			</td>
                    			
                    			<td>
                    				<?php echo $objData->hdc01hhcn_type_number; ?>
                    			</td>
                    			<td>
                    				<?php if (check_access_general(array('emp_edit'))): ?>
                    				<?php echo anchor("handrail_cable/create/".$objData->hdc01id, '<span class="form-edit floatRight">
                                        <img src="'.base_url('images/edit-btn.png').'" width="15" height="15"></span>'); ?>
                                            <a class="confirmation" data-href="<?php echo site_url('handrail_cable');?>/delete/?id=<?php echo $objData->hdc01id;?>" data-toggle="confirmation"  data-singleton="true" data-placement="left" data-btnOkClass="btn-danger" data-btnCancelClass="btn-success" data-title="Are you sure to delete?" data-data accesskey="ss" >
