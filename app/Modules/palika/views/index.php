...
<?= $this->section("body") ?>
    	...
    	<div class="container-fluid">
    		<div class="panel panel-default">
                ...
                <div class="AddBtn">
            	    ...
            	    <?php echo anchor('palika/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Create RM/UM</button>'); ?>
            	    <?php //endif ?>
               </div>
 ...
 <script>
    $(document).ready(function(){
        $url = '<?php echo site_url();?>/palika/ajaxData/';
           ...
           {data: 'muni01last_bridge_no'},
            {type: 'html',
                ...
                mRender: function( data, type, full ){
                    //console.log( data );
                    return '<a href="<?php echo site_url();?>/palika/create/'+ data +'">'+ $add +'</a> <a href="<?php echo site_url();?>/palika/delete/'+ data +'" onclick="return confirm(\'Are you sure you to delete this?\'">'+ $del +'</a>';
                }
            }
         ]
