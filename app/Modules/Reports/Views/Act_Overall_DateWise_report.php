...
<div id="page-wrapper " class="largeRpt">
    <div class="alignRight">
        <form method="post" action="<?php echo site_url(); ?>reports/Act_Overall_DateWise_print<?php echo (isset($blnMM) && $blnMM) ? '/' . MM_CODE : ''; ?>" target="_blank">
                ...
                <div class=" table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <b><span style="float:right;" >Province:<?php  echo  $arrDistInfo['province_name']; ?></span></b>
                            </div>
                        </div>     
                        </td>
                                    </tr>
