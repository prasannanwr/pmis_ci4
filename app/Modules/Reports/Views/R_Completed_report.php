				...
				<div class="row">
					<div class="col-lg-12 mainBoard">
						<!--<p class="reportHeader center">Bridge</p>-->
                        		<p class="reportHeader center">Completed Bridges</p>
                    ...
                    ?>
                      ...
                      //echo "<pre>"; print_r($tbsu_regional_off->tbis01name);exit;
                        ...
                        ?>
											...
											<tr class="dist_<?php echo $tbsu_regional_off->tbis01name;  ?>">
                                               <td><?php echo $i; ?></td>
                                                ...
                                                <td class="subStraCalc_dig" data-subt_first= ".dist_<?php echo $tbsu_regional_off->tbis01name;  ?> .Target_date" data-subt_second=".dist_<?php echo $tbsu_regional_off->tbis01name;  ?> .Compl_date" >0</td>                                                											
											</tr>
						<?php $i++; } } ?>    
                                               <tr>
