...
<div class="alignLeft noPrint" style="float:left;">
    <form name="frmDistrictFilter" method="get" action="<?php echo site_url();?>/reports/Act_Con_Districtwise_FYwise_report">
...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Act_Con_Districtwise_FYwise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
       <input type="hidden" name="start_year" value="<?php echo $startyear->fis01id; ?>" />
       <input type="hidden" name="end_year" value="<?php echo $endyear->fis01id; ?>" />
        ...
        <div class="container-fluid">
            <div class="row">
				<div class="col-lg-12 mainBoard">
					<p class="reportHeader center">Actual Cost Contribution (Between <?php echo $startyear->fis01year." - ".$endyear->fis01year;?>)</p>
                    <p class="reportHeader center" ></p>
					<div class=" table-responsive"> <!--mainBoard Ends-->	                               
