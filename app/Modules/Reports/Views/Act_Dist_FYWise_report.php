...
<div id="page-wrapper" class="largeRpt">
    <div class="alignLeft noPrint" style="float:left;">
        <form name="frmDistrictFilter" method="get" action="<?php echo site_url(); ?>/reports/Act_Dist_FYWise_report<?php echo (isset($blnMM) && $blnMM) ? '/' . MM_CODE : ''; ?>">
    ...
    <div class="alignRight">
        <form method="post" action="<?php echo site_url(); ?>reports/Act_Dist_FYWise_print<?php echo (isset($blnMM) && $blnMM) ? '/' . MM_CODE : ''; ?>" target="_blank">
            <input type="hidden" name="start_year" value="<?php echo $startyear->fis01id; ?>" />
            <input type="hidden" name="end_year" value="<?php echo $endyear->fis01id; ?>" />
            ...
            <div class="col-lg-12 mainBoard">
                ...
                <div class=" table-responsive">
                            ...
                            <tr>
                                ...
                                <th style="width:45px">
                                    <div class="vertical-text">
                                        <div class="vertical-text__inner">Span(m)</div>
                                    </div>
                                </th>
                                    ...
                                    <tbody class="distRegion_<?php echo $dataRow['info']->dist01id; ?>">
                                        ...
                                        <tr>
                                            <td colspan="22">
                                                ...
                                                <div class="col-lg-6">
                                                    <?php /*<b><span>Development:<?php   echo $dataRow['info']->dev01name; ?></span></b>*/ ?>
                    ...
                    <div class="footer_border2">
                        <div class="col-lg-3"><?php echo _day(); ?></div>
                        <div class="col-lg-6 "><span class="center">TBSU Programme Monitoring and Information Systerm PMIS</span></div>
