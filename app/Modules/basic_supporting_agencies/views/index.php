                    ...
                    <table class="table table-bordered table-hover table-striped">
                    	...
                    	<?php $i=1; foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td><?php echo $i++;?></td>
                    			<td>
                    				<?php // echo anchor('supporting_agencies/view/'.$objData->sup03id, $objData->sup03sup_agency_code); ?>
                                    <?php echo $objData->sup03sup_agency_code; ?>
                                    
                    			</td>
                    			<td>
                    				<?php echo $objData->sup03sup_agency_name; ?>
                    			</td>
                    			<td>
                    			 <?php 
                                   if($objData->sup03sup_agency_type == '' || $objData->sup03sup_agency_type == 0 )
                                   {
                                    echo "None" ;
                                   }elseif($objData->sup03sup_agency_type == 1)
                                   {
                                    echo "Local";
                                   }elseif($objData->sup03sup_agency_type == 2)
                                   {
                                     echo "Govt.";
                                   }elseif($objData->sup03sup_agency_type == 3)
                                   {
                                     echo "Other";
                                   }
                                  ?>
