    	...
    	<div class="container-fluid">
    		<div class="panel panel-default">
                ...
                <div class="AddBtn">
            	    ...
            	    <?php echo anchor('construction/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Create Construction</button>'); ?>
            	    <?php //endif ?>
               </div>
    
                <?php if (empty($arrDataList)): ?>
                <div id="infoMessage" class="alert alert-info">No Construction found.</div>
                <?php else: ?>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                    	...
                    	<?php $i=1; foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td><?php echo $i++;?></td>
                    			<td>
                    				<?php // echo anchor('construction/view/'.$objData->id, $objData->con02construction_type_code); ?>
                    			 <?php echo $objData->con02construction_type_code; ?>
                                </td>
                    			
                    			<td>
                    				<?php echo $objData->con02construction_type_name; ?>
                    			</td>
                    			<td>
